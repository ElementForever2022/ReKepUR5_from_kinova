...
# 绝对路径，随电脑变化
#sam的权重文件和配置文件的路径
checkpoint = "//home//liwenbo//project//yt//ReKepUR5_from_kinova//sam2model//sam2.1_hiera_base_plus.pt"
model_cfg = "//home//liwenbo//project//yt//ReKepUR5_from_kinova//sam2model//sam2.1_hiera_b+.yaml"
